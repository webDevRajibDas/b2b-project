...
use Brainstream\ProductPdfGenerate\Providers\ProductPdfGenerateServiceProvider;
...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware) {
        ...
        $middleware->remove(ProductPdfGenerateServiceProvider::class);
        $middleware->remove(ImageCropServiceProvider::class);
        /**
